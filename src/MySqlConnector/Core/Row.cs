...
internal abstract class Row
{
	...
	protected abstract sbyte XGetSByte(ReadOnlySpan<byte> data);

	protected abstract short XGetInt16(ReadOnlySpan<byte> data);

	protected abstract int XGetInt32(ReadOnlySpan<byte> data);

	protected abstract long XGetInt64(ReadOnlySpan<byte> data);
